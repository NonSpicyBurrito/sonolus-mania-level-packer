...
import { version as engineVersion } from 'sonolus-mania-engine'
import { ref } from 'vue'
...
<template>
    <h1 class="text-center text-xl font-bold sm:text-3xl">Sonolus Mania Level Packer</h1>

    <p>
        Pack your Mania levels into Sonolus collection packages. <br />
        <br />
        Sonolus: <br />
        ...
        <VLink url="https://github.com/NonSpicyBurrito/sonolus-mania-engine" /> <br />
        <br />
        Packer: <br />
        Version {{ appVersion }} <br />
        <VLink url="https://github.com/NonSpicyBurrito/sonolus-mania-level-packer" />
    </p>
    ...
    <form @submit.prevent="onPack">
        <div class="flex flex-col gap-4">
            ...
            <VFileField v-model="chart" label="Chart (OSU)" accept=".osu,.txt" required />
